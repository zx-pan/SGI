...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self.feat_dim = 50
        self.n_offsets = 2  # control the number of points in each anchor
    ...
    def extract(self, args):
        ...
        g.anchor_num = args.anchor_number
        g.feat_dim = args.feature_dim
        g.n_offsets = args.n_offsets_num
        print("Anchor number: ", g.anchor_num)
        print("Feature dim: ", g.feat_dim)
        print("Number of offsets: ", g.n_offsets)
        return g
